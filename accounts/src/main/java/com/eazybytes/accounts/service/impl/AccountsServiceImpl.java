...
public class AccountsServiceImpl  implements IAccountsService {
    ...
    private final StreamBridge streamBridge; //@AllArgsConstructor lo inicializa.
    ...
    private void sendCommunication(Accounts account, Customer customer) {
        ...
        boolean result = streamBridge.send("sendCommunication-out-0", accountsMsgDto); //El primer parámetro es el destination binding. 
